        ...
        <div className="grid gap-5 lg:grid-cols-[1.4fr_1fr]">
          <div className="min-w-0">
            ...
            <h2 className="mt-4 max-w-xl font-display text-[2.5rem] font-semibold leading-tight text-ink sm:text-4xl">
              让仓管员先看到
              <span className="block text-slate-500">“物料在哪” 和 “库位里有什么”</span>
            </h2>
            <p className="mt-4 max-w-xl text-sm leading-7 text-slate-600">
              所有库存以库位批次为单位记录，FIFO 按生产年月执行。浏览器只缓存页面和草稿，正式数据不依赖本地存储。
            </p>
          </div>
          <div className="rounded-[2rem] bg-ink p-5 text-white">
            ...
            <div className="mt-4 space-y-3">
              ...
              <ActionTile to={appRoutes.palletSearch} title="查库位" subtitle="直接查 P01 / S01 / IN-01" tone="dark" />
            </div>
          </div>
        </div>
      </section>
